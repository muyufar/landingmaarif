...
function ensureDistribusiLkpdSchema(): void
{
    ...
    if (!(bool) $pdo->query("SHOW TABLES LIKE 'distribusi_petugas'")->fetch()) {
        $pdo->exec(
    ...
    if (!(bool) $pdo->query("SHOW TABLES LIKE 'distribusi_lkpd_satuan'")->fetch()) {
        $pdo->exec(
    ...
    if (!(bool) $pdo->query("SHOW TABLES LIKE 'distribusi_lkpd_pengiriman'")->fetch()) {
        $pdo->exec(
